...
INSERT INTO Trip (Name, Description, DateFrom, DateTo, MaxPeople) VALUES
                                                                      ('Mediterranean Cruise', 'Explore the beautiful Mediterranean coast', CONVERT(datetime, '2025-06-15', 120), CONVERT(datetime, '2025-06-25', 120), 100),
                                                                      ('Paris Weekend', 'Romantic weekend in the city of love', CONVERT(datetime, '2025-05-10', 120), CONVERT(datetime, '2025-05-12', 120), 20),
                                                                      ('Greek Island Hopping', 'Visit multiple Greek islands in one trip', CONVERT(datetime, '2025-07-01', 120), CONVERT(datetime, '2025-07-12', 120), 30),
                                                                      ('Tuscany Wine Tour', 'Taste the finest wines of Tuscany', CONVERT(datetime, '2025-09-05',120), CONVERT(datetime, '2025-09-12', 120), 15),
                                                                      ('Egyptian Pyramids', 'Explore ancient Egyptian history', CONVERT(datetime, '2025-10-10', 120), CONVERT(datetime, '2025-10-20', 120 ), 25),
                                                                      ('Thai Beach Retreat', 'Relax on pristine Thai beaches', CONVERT(datetime, '2025-11-15', 120), CONVERT(datetime, '2025-11-29', 120), 40),
                                                                      ('Alpine Skiing', 'Ski trip to the Alps', CONVERT(datetime, '2026-01-10', 120), CONVERT(datetime, '2026-01-17', 120), 30),
                                                                      ('Spanish Fiesta', 'Experience Spanish culture and nightlife', CONVERT(datetime, '2025-08-01', 120), CONVERT(datetime, '2025-08-10', 120), 25),
                                                                      ('Adriatic Sailing', 'Sail along the Adriatic coastline', CONVERT(datetime, '2025-06-20', 120), CONVERT(datetime, '2025-06-30', 120), 12),
                                                                      ('Turkish Delight', 'Cultural tour of Turkey', CONVERT(datetime, '2025-05-20', 120), CONVERT(datetime, '2025-05-30', 120), 22);
